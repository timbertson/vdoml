...
in
{
  ...
  selection = 
  {
    ...
    ppx_assert = 
    {
      ...
      opamSrc = repoPath repo 
      {
        hash = "sha256:1b059bk45hrgrl5hkvmmgk7grsc8jiwgrz71lvzjgk5lgqfydg71";
        package = "packages/ppx_assert/ppx_assert.v0.12.0";
      };
      pname = "ppx_assert";
      src = pkgs.fetchurl 
      {
        sha256 = "09rv90ddygrjhflgyvplmq78szj43q8dp1awl0l96hlxm9547vl5";
        url = "https://ocaml.janestreet.com/ocaml-core/v0.12/files/ppx_assert-v0.12.0.tar.gz";
      };
      version = "v0.12.0";
    };
    ppx_compare = 
    {
      ...
      opamSrc = repoPath repo 
      {
        hash = "sha256:08gjmw36hqwnkicm7b93r2f4vhl8s53hbq38gms09p8qbz4yday9";
        package = "packages/ppx_compare/ppx_compare.v0.12.0";
      };
      pname = "ppx_compare";
      src = pkgs.fetchurl 
      {
        sha256 = "1v1gm4zvf8al276khya1lr2ml27k28brjzhrklyr4891gfi2pra8";
        url = "https://ocaml.janestreet.com/ocaml-core/v0.12/files/ppx_compare-v0.12.0.tar.gz";
      };
      version = "v0.12.0";
    };
    ppx_derivers = 
    ...
    ppx_here = 
    {
      ...
      opamSrc = repoPath repo 
      {
        hash = "sha256:04s41f20gihv3fnbz6jrf0v88r069dmsy77y311gcp0nlcx38bi2";
        package = "packages/ppx_here/ppx_here.v0.12.0";
      };
      pname = "ppx_here";
      src = pkgs.fetchurl 
      {
        sha256 = "09m9pwsiy2s13dqilamkynzbr7k1h1jnh9d7qad0r62jx9zbma2f";
        url = "https://ocaml.janestreet.com/ocaml-core/v0.12/files/ppx_here-v0.12.0.tar.gz";
      };
      version = "v0.12.0";
    };
    ppx_inline_test = 
    {
      ...
      opamSrc = repoPath repo 
      {
        hash = "sha256:00m6w0p7rhflz1w9sv8g9q21zycdy207yqf8m097h2zfwwzgy736";
        package = "packages/ppx_inline_test/ppx_inline_test.v0.12.0";
      };
      pname = "ppx_inline_test";
      src = pkgs.fetchurl 
      {
        sha256 = "0vngw6m24sj71bj51v4pp8rv4irf94fadbz1f23n6r5yrx8g7am0";
        url = "https://ocaml.janestreet.com/ocaml-core/v0.12/files/ppx_inline_test-v0.12.0.tar.gz";
      };
      version = "v0.12.0";
    };
    ppx_sexp_conv = 
